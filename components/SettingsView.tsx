...
const SettingsView: React.FC<SettingsViewProps> = ({ settings, onUpdateSettings, onBack, onExport, onImport }) => {
  ...
  return (
    <div className="max-w-md mx-auto bg-white p-4 md:p-6 rounded-2xl shadow-lg border border-gray-100 max-h-[90vh] overflow-y-auto">
          ...
          <div className="border border-gray-200 rounded-xl overflow-hidden max-h-48 overflow-y-auto">
            ...
            {availableVoices.map((v) => (
              <button
                ...
                className={`w-full flex items-center justify-between px-4 py-3 border-b border-gray-100 last:border-0 transition-all text-left ${
            ...
            <div className="flex gap-4">
                {[1, 2, 3].map(count => (
                    <button
                        ...
                        className={`w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg border transition-all ${
                             settings.autoRepeat === count 
      ...
      <div className="mt-8 pt-4 border-t border-gray-100">
        <button
          onClick={onBack}
          className="w-full py-3 bg-gray-900 text-white rounded-xl font-semibold shadow-md hover:bg-gray-800 transition-colors"
        >
          完成
        </button>
      </div>
